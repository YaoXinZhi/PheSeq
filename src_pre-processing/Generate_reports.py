...
def main():
    ...
    # loose - for p-vec
    # save_para = {(0, 0.1), (0, 0.4), (0, 0.6),
    #              (0.1, 0.2), (0.1, 0.4), (0.1, 0.6), (0.1, 0.8), (0.1, 1),
    #              (0.3, 0), (0.3, 0.4), (0.3, 0.6),
    #              (0.5, 0.4), (0.5, 0.6),
    #              (0.7, 0.2), (0.7, 0.4), (0.7, 0.6),
    #              (0.9, 0.6)}

    # tight - for p-vec
    # save_para = {(0, 0.6,), # wangli
    #             (0.1, 0.6,), # wangli
    #              (0.3, 0), # wangli
    #              #(0.3, 0.4,), # (0.3, 0) 趋势并不是很明显 但期望可以增加召回
    #              (0.5, 0.4), # wangli running
    #              (0.7, 0.2), # wangli running
    #              #(0.7, 0.6), ·# (0.7, 0.2) 增加召回
    #              (0.9, 0.6)} # wangli
